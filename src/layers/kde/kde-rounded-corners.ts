...
export class KdeRoundedCornersLayer extends GenericLayer {
    ...
    // src = fetchGit("https://github.com/matinlotfali/KDE-Rounded-Corners", "v0.10.0");
    src = fetchGit(
        "https://github.com/matinlotfali/KDE-Rounded-Corners",
        "4c5dce7d9190d077f51e87b095ce322a9483af97",
    );
        ...
        return dag
            ...
            .withFile(
                ...
                await mkRPM(buildContainer)(
                    { name: "kde-rounded-corners", version: this.src.ref },
                    content,
                ),
            );
    }
